...
<head>
    ...
    <title>Quan ly danh sach khach hang</title>
    <!-- Favicon-->
...
<body class="theme-red">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    while ($row = mysqli_fetch_array($result)) 
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn btn-danger" onclick="confirmDelete(<?= $row['id'] ?>)">Xóa</button></td>
                                        </tr>
                                    <?php 
                                    }
                                     ?>
    ...
    <!-- Thêm script SweetAlert2 trước </body> -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php elseif ($_GET['delete'] == 'error'): ?>
                Swal.fire({
                    title: 'Lỗi!',
                    text: '<?php echo isset($_GET['message']) ? htmlspecialchars($_GET['message']) : "Có lỗi xảy ra khi xóa khách hàng"; ?>',
                    icon: 'error',
                    confirmButtonText: 'OK'
                });
            <?php endif; ?>
